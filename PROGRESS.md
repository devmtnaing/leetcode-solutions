...
| 2 | Remaining 14 lessons, 3 at a time | in progress — batch 1 running |
...
| 4 | 121 | Best Time to Buy and Sell Stock | every pair O(n²) | one pass, track min | bars + markers | batch 1 |
...
| 10 | 242 | Valid Anagram | sort both O(n log n) | count array O(n) | two strips + counts | batch 1 |
...
| 13 | 283 | Move Zeroes | build new array | two pointers in place | strip + 2 pointers | batch 1 |
