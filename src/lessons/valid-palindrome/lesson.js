...
mountLesson({
  ...
  verification: {
    ruby: 'run here · 17 edge cases + 20,000 random, identical digest',
    python: 'run here · 17 edge cases + 20,000 random, identical digest',
    javascript: 'run here · 17 edge cases + 20,000 random, identical digest',
